...
class DatabaseHelper {
  ...
  Future<void> _onCreate(Database db, int version) async {
    ...
    await db.execute(
      "CREATE TABLE IF NOT EXISTS weekly_reports IF NOT EXISTS weekly_reports(id INTEGER PRIMARY KEY, from_date TEXT, to_date TEXT, report_data TEXT,account_id INTEGER, FOREIGN KEY (account_id) REFERENCES accounts(id) ON UPDATE CASCADE)",
    );
  }
