                      ...
                      children: [
                        ...
                        di<AuthModel>().region == Country.kenya.name
                            ? Padding(
                                padding: EdgeInsets.all(8),
                                child: Text(
                                  'Great news! Transaction auto-import from SMS is fully supported in Kenya. You will be able to automatically import your transactions from supported banks.',
                                  style: TextStyle(
