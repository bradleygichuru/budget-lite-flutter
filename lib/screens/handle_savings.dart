...
class HandleSavings extends StatefulWidget with WatchItStatefulWidgetMixin {
...
class HandleBalanceState extends State<HandleSavings>
  ...
  final GlobalKey<ScaffoldMessengerState> handleSScaffoldMessengerKey =
  ...
  Widget build(BuildContext context) {
                            ...
                            if (addTs.value != 0) {
                              if (context.mounted) {
                                handleSScaffoldMessengerKey.currentState!
                                    .showSnackBar(
                                      SnackBar(
                                        content: const Text("Added to savings"),
                                      ),
                                    );
                                Navigator.pop(context);
                                addSC.clear();
    ...
    Future<void> moveToCashBalance() {
      TextEditingController moveSC = TextEditingController();
      return showDialog(
        context: context,
        builder: (context) {
          return AlertDialog(
            title: Text("Remove from savings"),
            content: Padding(
              padding: EdgeInsets.all(6),
              child: TextField(
                keyboardType: TextInputType.number,
    ...
    return MaterialApp(
      ...
      home: ScaffoldMessenger(
        key: handleSScaffoldMessengerKey,
